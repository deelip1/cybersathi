...
try{$phones=$pdo->query('SELECT phone,fraud_type,report_count FROM fraud_phone_reports ORDER BY report_count DESC LIMIT 20')->fetchAll();}catch(Throwable $e){$phones=[];}
?>
