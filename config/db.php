...
function bootstrap_sqlite(PDO $pdo): void {
    ...
    $pdo->exec('CREATE TABLE IF NOT EXISTS volunteers (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, email TEXT UNIQUE, mobile TEXT, city TEXT, skills TEXT, occupation TEXT, approval_status TEXT DEFAULT "pending", created_at TEXT DEFAULT CURRENT_TIMESTAMP)');
