...
function bootstrap_mysql(PDO $pdo): void {
    ...
    // Compatibility migration for older schemas
    ...
    if($c===0){
        $pdo->prepare('INSERT INTO admin(name,email,password_hash) VALUES(?,?,?)')->execute([
            'Cyber Sathi Admin','admin@cybersathi.org',password_hash('admin123', PASSWORD_BCRYPT)
        ]);
    }
